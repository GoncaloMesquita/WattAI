...
class MLPEnvironment(gym.Env):
    def __init__(self, your_mlp_function, state_dim, action_dim):
        ...
        self.action_space = spaces.Box(low=np.array([20.14,9.40,0,0,0]), high=np.array([29.35,23,100,100,100]), shape=(action_dim,), dtype=np.float64) # Falta definir as bounds
